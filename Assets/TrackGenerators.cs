...
public class TrackGenerators : MonoBehaviour
{
    private Vector3 currentBuildPosition = new Vector3(192.5f, 0.1f, 200f );
    public int initialTrackLength = 2;
...
// Mangler skelne mellem om det er et elemnent som skal generere bane ved spiller kontakt, eller ære pasiv
 ...
 //float startZPosition = 200;
            ...
            trackPiece.transform.position = new Vector3(currentBuildPosition.x + xPosition, 0.1f, currentBuildPosition.z + zPosition);
...
StraightTrackController controller = trackPiece.GetComponent<StraightTrackController>();
 ...
 float zPosition = zDisplacement / 2;
    ...
    */
    ...
    GameObject trackPiece = LeftCornerPiecesPool.SharedInstance.GetTrack();

LeftCornerController controller = trackPiece.GetComponent<LeftCornerController>();
      ...
      if(trackPiece != null)
        {
            ...
            else if(currentDirection == "East")
            {
             ...
             newYValue = currentBuildPosition.z - xPosition;
